...
XCVAR_DEF( cg_drawMovementKeysPos,				"451 430",				CG_SetMovementKeysPos,	CVAR_ARCHIVE )
...
//japro stuff
XCVAR_DEF(cg_drawScore,							"1",					NULL,					CVAR_ARCHIVE)
XCVAR_DEF(cg_newFollowText,						"0",					NULL,					CVAR_ARCHIVE)
XCVAR_DEF(cg_chatBoxSize,						"1",					NULL,					CVAR_ARCHIVE)
XCVAR_DEF(cg_raceTimer,							"0",					NULL,					CVAR_ARCHIVE)
...
XCVAR_DEF(cg_brightSkins,						"0",					NULL,					CVAR_ARCHIVE)
