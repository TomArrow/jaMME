...
#define	JAPRO_COSMETIC_RPG		(1<<28)
...
void		trap_FX_PlayEffectIDFix		( int id, vec3_t org, vec3_t fwd, int vol, int rad );		// builds arbitrary perp. right vector, does a cross product to define up
